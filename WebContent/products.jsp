            ...
            <div class="row">                  
               <div class="span9">                        
                  ...
                  <div class="pagination pagination-small pagination-centered">
                    ...
                    <ul>
                         <c:if test="${prev == 1}">
                        <li><a href="./products.mvc?main_cate=${main}&sub_cate=${sub}&pageNum=${prevNum}">Prev</a></li>
                         </c:if>
                        <c:forEach begin="${startPage}" end="${endPage}" varStatus="i">
                        <li><a href="./products.mvc?main_cate=${main}&sub_cate=${sub}&pageNum=${i.index}">${i.index}</a></li>
                        </c:forEach>
                        <c:if test="${next == 1}">
                        <li><a href="./products.mvc?main_cate=${main}&sub_cate=${sub}&pageNum=${nextNum}">Next</a></li>
                        </c:if>
                     </ul>
                  </div>
               </div>
