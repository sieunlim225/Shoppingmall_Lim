                        ...
                        <div id="myCarousel" class="myCarousel carousel slide">
                           <div class="carousel-inner">
                              ...
                              <div class="active item">
                                 <ul class="thumbnails">                           
                                    <c:forEach items="${best}" var="best" begin="0" end="8" varStatus="i"> <!-- 판매량이 많은 아이템들이 4개 보여져야한다.  -->                     
                                       <li class="span3">
                     ...
                     <div class="span12">
                        ...
                        <div id="myCarousel-2" class="myCarousel carousel slide">
                           <div class="carousel-inner">
                              <div class="active item">
                                 <ul class="thumbnails">      
                                    <c:forEach items="${newB}" var="newB" begin="0" end="8" varStatus="i"> <!-- 판매량이 많은 아이템들이 4개 보여져야한다.  -->                     
                                       <li class="span3">
                                          <div class="product-box">
                                             <span class="sale_tag"></span>
